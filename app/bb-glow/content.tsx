      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <motion.div 
            ...
            className="border border-gray-800 p-8 h-full flex flex-col"
          >
            <h2 className="text-3xl font-bold mb-4 text-pink-400">Ohne Microneedling</h2>
            <p className="text-gray-400 mb-6">(inkl. Voreinigung + BBGLOW)</p>
          ...
          >
            ...
            <p className="text-gray-400 mb-6">(inkl. Voreinigung + Microneedling + BBGLOW)</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-300 mb-4">BB Glow hilft gegen viele Probleme:</p>

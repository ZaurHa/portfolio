    ...
    <main className="bg-black text-white">
      <div className="container mx-auto px-4 py-20 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-gray-400 text-sm mb-6 text-center">(inkl. RF Microneedling + beruhigende Maske)</p>
          
          <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                <Check className="w-5 h-5 text-pink-400 mt-1 mr-4 flex-shrink-0" />
                <span className="text-gray-300">Sichtbare Reduzierung von Dehnungsstreifen</span>
              </li>
              <li className="flex items-start">
                <Check className="w-5 h-5 text-pink-400 mt-1 mr-4 flex-shrink-0" />
                <span className="text-gray-300">Verbesserung der Hautelastizität und -festigkeit</span>
              </li>
              <li className="flex items-start">
                <Check className="w-5 h-5 text-pink-400 mt-1 mr-4 flex-shrink-0" />
                <span className="text-gray-300">Stimulierung der körpereigenen Kollagenproduktion</span>
              </li>
          </ul>

          <div className="mt-auto text-center">
            <p className="text-lg text-gray-300">Bauch</p>
            <p className="text-5xl font-bold mb-4">199,00€</p>
            <p className="text-sm text-gray-400">Weitere Areale: Aufpreis 19,00€</p>
            <p className="text-sm text-gray-400">Jelly Maske: Aufpreis 10,00€</p>
          </div>
        </motion.div>

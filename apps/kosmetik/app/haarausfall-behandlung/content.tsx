    ...
    <main className="bg-black text-white">
      <div className="container mx-auto px-4 py-20 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-neutral-400 text-sm mb-6 text-center">Eine Kombination aus Microneedling und Lasertherapie.</p>
          ...
          <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                ...
                <div>
                    ...
                    <p className="text-neutral-400">Aktiviert die Haarfollikel und regt das Haarwachstum an.</p>
                </div>
              </li>
              <li className="flex items-start">
                <Check className="w-5 h-5 text-pink-400 mt-1 mr-4 flex-shrink-0" />
                 <div>
                    ...
                    <p className="text-neutral-400">Fördert die Durchblutung und stärkt die Follikel.</p>
                </div>
              </li>
              <li className="flex items-start">
                <Check className="w-5 h-5 text-pink-400 mt-1 mr-4 flex-shrink-0" />
                <span className="text-neutral-300">Sichtbare Ergebnisse ab der 5. Sitzung – auch bei Geheimratsecken und dünnem Haar.</span>
              </li>
          </ul>
